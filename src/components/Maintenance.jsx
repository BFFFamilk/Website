              ...
              <div className="bg-white rounded-lg shadow-lg p-5 md:p-20 mx-2">
                  <div className="text-center">
                      <h2
                          ...
                          BFF<span className="text-cyan-500">Familk</span>
                      </h2>
                      <h3 className='text-xl md:text-3xl mt-10'>Coming Soon</h3>
                      <p className="text-md md:text-xl mt-10"><a className="hover:underline" href="#">BFFFamilk Web</a> is a personal website
                          share information about the owner of website.</p>
                  </div>
                  <div className="flex flex-wrap mt-10 justify-center">
                      <div className="m-3">
                          <a href="#" title="BFFFamilk On Facebook"
                      ...
                      <div className="m-3">
                          <a href="#" title="BFFFamilk On Twitter"
                      ...
                      <div className="m-3">
                          <a href="#" title="BFFFamilk On Pinterest"
